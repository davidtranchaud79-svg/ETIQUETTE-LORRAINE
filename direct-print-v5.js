...
(function(){
  ...
  // CT321D : le firmware de ce modèle utilise la polarité raster inverse
  // du TSPL standard. 1 = papier blanc, 0 = point noir.
  // On part donc d'un buffer blanc (0xFF) et on efface uniquement les bits noirs.
